      ...
      <section id="contact" className="grid md:grid-cols-2 my-8 md:my-12 py-24 gap-2 relative">
        ...
        <div className="z-10">
          ...
          <p className="text-[#ADB7BE] mb-4 max-w-md">
            I&apos;m actively seeking new opportunities and welcome any inquiries or messages. Whether you have a question or simply want to connect, feel free to reach out&mdash;I&apos;ll be sure to respond promptly!
          </p>
